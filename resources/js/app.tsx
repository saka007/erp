...
createInertiaApp({
    ...
    resolve: (name) => {
        const allPages = {
            ...
            ...import.meta.glob('../../packages/DigitalFuzed/*/src/Resources/js/Pages/**/*.tsx')
        };
        ...
        const packagePagePath = `../../packages/DigitalFuzed/${packageName}/src/Resources/js/Pages/${pagePath.join('/')}.tsx`;
