...
class PermissionRoleSeeder extends Seeder
{
    public function run()
    {
        ...
        $permissions = [
            ...
            ['name' => 'manage-module-governance', 'module' => 'settings', 'label' => 'Manage Module Governance'],
            ['name' => 'manage-module-entitlements', 'module' => 'settings', 'label' => 'Manage Module Entitlements'],
            ['name' => 'request-module-activation', 'module' => 'settings', 'label' => 'Request Module Activation'],
            ['name' => 'approve-module-requests', 'module' => 'settings', 'label' => 'Approve Module Requests'],
        ...
        $roles = [
            ...
            'company' => [
                ...
                'permissions' => [
                    ...
                    'manage-settings', 'edit-settings', 'manage-brand-settings', 'edit-brand-settings', 'manage-company-settings', 'edit-company-settings', 'manage-system-settings', 'edit-system-settings', 'manage-email-settings', 'edit-email-settings', 'test-email','manage-email-notification-settings', 'manage-module-governance', 'request-module-activation',
                    ...
                    'manage-plans', 'manage-own-plans', 'view-plans',
