                        ...
                        <div className="grid gap-6 xl:grid-cols-2">
                            <TextileFormCard title={t('Log Fuel Entry')} icon={Fuel}>
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <SelectField label={t('Fuel Type')} value={fuelForm.data.fuel_type} onChange={(value: string) => fuelForm.setData('fuel_type', value)} options={resolvedFuelTypeOptions} includeEmpty emptyLabel={t('Select fuel type')} helperText={t('Managed from Master Setup > Transport Setup > Fuel Types.')} />
                            ...
                            <TextileFormCard title={t('Record Freight Cost')} icon={IndianRupee}>
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <SelectField label={t('Freight Type')} value={freightForm.data.freight_type} onChange={(value: string) => freightForm.setData('freight_type', value)} options={resolvedFreightTypeOptions} includeEmpty emptyLabel={t('Select freight type')} helperText={t('Managed from Master Setup > Transport Setup > Freight Types.')} />
                                    </div>
