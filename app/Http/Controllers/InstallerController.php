...
class InstallerController extends Controller
{
    ...
    private function enableModule($moduleName)
    {
        ...
        if (empty($addon)) {
            $filePath = base_path('packages/DigitalFuzed/' . $moduleName . '/module.json');
            ...
            Artisan::call('migrate --path=/packages/DigitalFuzed/' . $moduleName . '/src/Database/Migrations --force');
            Artisan::call('package:seed ' . $moduleName);
            $addon->is_enable = 1;
            $addon->save();
        }
