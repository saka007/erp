...
class ModuleController extends Controller
{
    ...
    public function enable(Request $request)
    {
        ...
        if (!empty($module)) {
            ...
            if ($module->isEnabled()) {
                ...
                if (empty($addon)) {
                    Artisan::call('migrate --path=/packages/DigitalFuzed/' . $request->name . '/src/Database/Migrations --force');
                    Artisan::call('package:seed ' . $request->name);

                    $filePath = base_path('packages/DigitalFuzed/' . $request->name . '/module.json');
            ...
            if (File::exists($moduleJsonPath)) {
                ...
                if ($moduleData) {
                    ...
                    $modules[] = [
                        ...
                        'image' => url('/packages/DigitalFuzed/' . $moduleName . '/favicon.png'),
    ...
    private function installSinglePackage($file)
    {
        ...
        $tempPath = base_path('packages/DigitalFuzed/tmp_' . uniqid());
        ...
        $extractPath = base_path('packages/DigitalFuzed/' . $moduleData['name']);
        ...
        foreach ($userActiveModules as $userModule) {
            ...
            if ($addon) {
                $modules[] = [
                    ...
                    'alias' => $addon->name,
                    'image' => url('/packages/DigitalFuzed/' . $userModule->module . '/favicon.png'),
